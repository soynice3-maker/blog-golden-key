            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm space-y-5">
              <div>
                ...
                <input type="text" placeholder="예: 문래 라멘 로라멘 후기" value={topic} onChange={e => setTopic(e.target.value)}
                  className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-blue-400 placeholder:text-gray-400" />
              ...
              <div>
                ...
                <div className="w-full px-3 py-2 border border-gray-200 rounded-xl text-sm focus-within:border-blue-400 flex flex-wrap gap-2 min-h-[46px] cursor-text"
                  ...
                  {keywords.length === 0 && (
                    <input id="keyword-input" type="text"
                      ...
                      className="flex-1 min-w-[120px] outline-none bg-transparent py-1 placeholder:text-gray-400" />
                  )}
                </div>
              ...
              <div>
                ...
                <textarea placeholder={`예)\n주차가 협소해서 대중교통 이용 추천\n웨이팅이 있지만 회전율이 빨라서 금방 입장 가능\n떡볶이보다 튀김이 더 맛있었음\n혼밥하기 좋은 1인석 있음`}
                  ...
                  className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-blue-400 resize-none placeholder:text-gray-400" />
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input type="text" placeholder="예: https://map.naver.com/p/... (네이버 플레이스 URL)"
                    ...
                    className="flex-1 px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-blue-400 placeholder:text-gray-400" />
