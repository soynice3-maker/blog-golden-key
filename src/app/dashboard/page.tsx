            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm space-y-5">
              ...
              <div>
                ...
                <textarea placeholder={`예)\n주차가 협소해서 대중교통 이용 추천\n웨이팅이 있지만 회전율이 빨라서 금방 입장 가능\n떡볶이보다 튀김이 더 맛있었음\n혼밥하기 좋은 1인석 있음`}
                  ...
                  className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-blue-400 resize-none placeholder:text-gray-300" />
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input type="text" placeholder="예: https://map.naver.com/p/... (네이버 플레이스 URL)"
                    ...
                    className="flex-1 px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-blue-400 placeholder:text-gray-300" />
