...
import { TrendingUp, ChevronLeft, Mail, Briefcase, Building2, GraduationCap, Heart } from 'lucide-react'
    ...
    <div className="min-h-screen bg-[#f9fafb]">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <section className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl p-8 text-center">
          ...
          <a
            href="mailto:lavidacarinosa@naver.com?subject=[키라이즈] 상위노출 대행 문의&body=안녕하세요, 상위노출 대행 문의드립니다.%0D%0A%0D%0A- 업종:%0D%0A- 운영 중인 블로그 (있다면):%0D%0A- 목표:%0D%0A- 예산:%0D%0A- 문의 내용:"
